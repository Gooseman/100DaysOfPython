...
from states_game.game_map import GameMap
from states_game.score import Score
from states_game.state_entry import StateEntry
from states_game.states import States
...
class GameBoard:
    ...
    def _create_ui_components(self):
        ...
        self.score = Score(parent=self.top_middle)
        ...
        self.game_map = GameMap(canvas=self.canvas)
