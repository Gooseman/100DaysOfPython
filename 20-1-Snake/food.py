...
class Food:
    def __init__(self, screen, food_size_factor):
        self.game_length, self.game_height = screen.screensize()
        ...
        self.food_placer.shapesize(
            stretch_len=food_size_factor, stretch_wid=food_size_factor
        )
